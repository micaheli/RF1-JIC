...
static float kpAttenuationCurve[ATTENUATION_CURVE_SIZE] = {1.30, 1.15, 1.00, 0.90, 0.80, 0.90, 1.00, 1.10, 1.20};
static float kiAttenuationCurve[ATTENUATION_CURVE_SIZE] = {1.00, 1.00, 1.00, 0.95, 0.90, 0.95, 1.00, 1.05, 1.10};
