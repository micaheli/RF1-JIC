...
#define FIRMWARE_VERSION_INT	(uint16_t)(374U)
#define CONFIG_VERSION			(uint8_t)(138U)
#define CONFIG_VERSION_STR		"138"
#define FIRMWARE_VERSION		"0.374.138 BETA" //RC19 is next
