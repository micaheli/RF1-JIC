...
#define MAX_OSD_SPI_NUMBER				ENUM_SPI2
#define MAX_OSD_SPI_CS_GPIO_Pin			SPI2_NSS_PIN
#define MAX_OSD_SPI_CS_GPIO_Port		SPI2_NSS_GPIO_PORT
#define MAX_OSD_SPI_SCK_PIN				SPI2_SCK_PIN
#define MAX_OSD_SPI_SCK_GPIO_PORT		SPI2_SCK_GPIO_PORT
#define MAX_OSD_SPI_SCK_AF				SPI2_SCK_AF
#define MAX_OSD_SPI_MISO_PIN			SPI2_MISO_PIN
#define MAX_OSD_SPI_MISO_GPIO_PORT		SPI2_MISO_GPIO_PORT
#define MAX_OSD_SPI_MISO_AF				SPI2_MISO_AF
