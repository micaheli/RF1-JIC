...
#define LED1_GPIO_Port          ENUM_PORTE
...
#define VBUS_SENSING_PIN			GPIO_PIN_4

//ADC Config
#define ADC0_TYPE					ADC_CURRENT
#define ADC0_PORT					ENUM_PORTC
#define ADC0_PIN					GPIO_PIN_2
#define ADC0_INSTANCE				ENUM_ADC3
#define ADC0_CHANNEL				ADC_CHANNEL_12
...
#define MAX_OSD_TX_DMA_FP				FP_DMA1_S3
