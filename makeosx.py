...
asm_command = "/usr/local/gcc-arm/bin/arm-none-eabi-gcc -c {USECOLOR} -o output/{OUTPUT_FILE} {ASMFLAGS} {INPUT_FILE}"

compile_command = "/usr/local/gcc-arm/bin/arm-none-eabi-gcc -c {USECOLOR} -o output/{OUTPUT_FILE} {CFLAGS} {INPUT_FILE}"

link_command = "/usr/local/gcc-arm/bin/arm-none-eabi-gcc {USECOLOR} -o output/{OUTPUT_NAME}.elf {OBJS} {LDFLAGS}"

size_command = "/usr/local/gcc-arm/bin/arm-none-eabi-size output/{OUTPUT_NAME}.elf"

copy_obj_command = "/usr/local/gcc-arm/bin/arm-none-eabi-objcopy -O binary output/{OUTPUT_NAME}.elf output/{OUTPUT_NAME}.bin"
