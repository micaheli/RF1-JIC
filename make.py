...
def configure_target(TARGET):
    ...
    STM32F7_DEF_FLAGS = "-DUSE_HAL_DRIVER -DHSE_VALUE=8000000 -DPROJECT=" + PROJECT + " -D" + PROJECT + " -D" + FC_NAME +" -D" + TARGET_DEVICE + " -DARM_MATH_CM7 -DUSE_HAL_DRIVER -D__FPU_PRESENT -D" + TARGET + " -D" + TARGET_DEVICE_LC + " -D" + TARGET_PROCESSOR_TYPE
